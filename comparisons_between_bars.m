function comparisons_between_bars(xx, cond_vals)
        ...
        if a1<a2
            ...
            if adj_p(pcount) < 0.05
                ...
                if adj_p(pcount) < 0.001
                    text((xx(a1)+xx(a2))/2,ymax+(count), '***','HorizontalAlignment','center');
                elseif adj_p(pcount) < 0.01
                    text((xx(a1)+xx(a2))/2,ymax+(count), '**','HorizontalAlignment','center');
                else text((xx(a1)+xx(a2))/2,ymax+(count), '*','HorizontalAlignment','center');
                end
            end
