...
const event_boundary_task = function () {
    ...
    const instructions_pg7 = function () {
        ...
        content.innerHTML =
            ...
            <div>
                ...
                This will then be followed by a memory test consisting of 11 trials.
                In the memory test, you must get at least 50% (6 trials) of the temporal order judgements correct to move on to the main experiment. 
    ...
    const show_choiceDisplay = function () {
        ...
        if (block_counter >= trials.length) {
            ...
            encoding_score = (100 * mainexp_acc / 432)
            memory_score = (100 * mem_main_acc /132)
            document.querySelector("#main-display").style.display = "flex"
            document.querySelector("#main-display").innerHTML = `
                        <div class="content-display flex flex-column justify-center f6 lh-copy" style="text-align: left">
                        </div>`
            document.querySelector(".content-display").innerHTML =
                `<div>
                    <div>
                        ...
                        <p style="font-size: 32px">Your accuracy for the memory order task is `+ memory_score.toFixed(2) + `%</p>
                    <br>
                    </div>
                    <div>
    ...
    const end_practice = function () {
        ...
        if (practice_acc >= 29 && mem_practice_acc >= 6) {
            // create content display within the main-display div
            document.querySelector("#main-display").style.display = "flex"
            document.querySelector("#main-display").innerHTML = `
                        <div class="content-display flex flex-column justify-center f6 lh-copy" style="text-align: left">
    ...
    const redo_practice = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div><p>You have either not achieved above 80% accuracy during the judgement task (i.e., having too many missed responses) or have not achieved above 50% in the memory test. Let's practice again just to make sure you have gotten everything clear.</p>
    ...
    const memory_order_test = function () {
        ...
        if (mem_trial_counter == mem_test.length) {
            ...
            document.querySelector("#main-display").innerHTML =
                `<div>
                <div class="standard-display absolute-center">
                    <p style="font-size: 28px"> You have completed `+ block_counter + ` out of 12 blocks. </p>
                </div>
                <div class="standard-display absolute-center">
