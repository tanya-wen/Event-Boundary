...
const event_boundary_task = function () {
    ...
    const instructions_pg1 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this task you will be asked to make judgements on the image in the center of the screen. 
    ...
    const instructions_pg2 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this example, there is an object the middle of the screen. You are asked to press "Z" if it is manmade and "M" if it is natural. The correct answer is "M".</p>
    ...
    const instructions_pg3 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this example, there is an object in the middle of the screen . You are asked to press "Z" if it is small and "M" if it is large. The correct answer is "Z".</p>
                            <p><strong>*NOTE: Please use whether an object is smaller or larger than a <span style="color:red">shoebox</span> as a reference of whether the object is small or large.*</strong></p>
    ...
    const instructions_pg4 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this example, there is a word in the middle of the screen . You are asked to press "Z" if it abstract on and "M" if it concrete. The correct answer is "Z".</p>
                            <p><strong>*NOTE: Abstract words refer to intangible qualities, ideas, and concepts. These words indicate things we know only through our intellect, like "truth," "honor," "kindness," and "grace."
                            Concrete words refer to tangible, qualities or characteristics, things we know through our senses. Words like "food," "cat," and "green" are concrete.*</strong></p>
    ...
    const instructions_pg5 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this example, there is a word in the middle of the screen . You are asked to press "Z" if it has 1 syllable on and "M" if it has 2 syllables. The correct answer is "M".</p>

                            <div class="standard-display absolute-center">
                                    <img src="images/example-4.png" style="width: 800px"></img>
                            </div>
                            <div class="flex flex-row" style="">
                                <a id="dyn-bttn-2" class="bttn b-left f6 link dim ph3 pv2 mb2 dib white bg-dark-gray" href="#0">PREVIOUS</a>
                                <a id="dyn-bttn" class="bttn b-right f6 link dim ph3 pv2 mb2 dib white bg-green" href="#0">NEXT</a>
    ...
    const instructions_pg6 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this example, there is a scene in the middle of the screen . You are asked to press "Z" if it is a cottage on and "M" if it is a skysrcaper. The correct answer is "Z".</p>

                            <div class="standard-display absolute-center">
                                    <img src="images/example-5.png" style="width: 800px"></img>
                            </div>
                            <div class="flex flex-row" style="">
                                <a id="dyn-bttn-2" class="bttn b-left f6 link dim ph3 pv2 mb2 dib white bg-dark-gray" href="#0">PREVIOUS</a>
                                <a id="dyn-bttn" class="bttn b-right f6 link dim ph3 pv2 mb2 dib white bg-green" href="#0">NEXT</a>
    ...
    const instructions_pg7 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        <h3> Instructions </h3>
                        <div>
                            <p>In this example, there is a scene in the middle of the screen . You are asked to press "Z" if it is indoor on and "M" if it is outdoor. The correct answer is "M".</p>

                            <div class="standard-display absolute-center">
                                    <img src="images/example-6.png" style="width: 800px"></img>
                            </div>
                            <div class="flex flex-row" style="">
                                <a id="dyn-bttn-2" class="bttn b-left f6 link dim ph3 pv2 mb2 dib white bg-dark-gray" href="#0">PREVIOUS</a>
                                <a id="dyn-bttn" class="bttn b-right f6 link dim ph3 pv2 mb2 dib white bg-green" href="#0">NEXT</a>
        ...
        document.querySelector("#dyn-bttn").setAttribute("onClick", "javascript: event_boundary_task.instructions_pg8();")
        document.querySelector(".content-display").style.visibility = "visible"
    }
    ...
    const instructions_pg8 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        ...
                        `
        document.querySelector("#dyn-bttn-2").setAttribute("onClick", "javascript: event_boundary_task.instructions_pg7();")
        document.querySelector("#dyn-bttn").setAttribute("onClick", "javascript: event_boundary_task.instructions_pg9();")
        document.querySelector(".content-display").style.visibility = "visible"
    }
    ...
    const instructions_pg9 = function () {
        ...
        document.querySelector(".content-display").innerHTML = `
                        ...
                        `
        document.querySelector("#dyn-bttn-2").setAttribute("onClick", "javascript: event_boundary_task.instructions_pg8();")
        document.querySelector("#dyn-bttn").setAttribute("onClick", "javascript: event_boundary_task.instructions_pg10();")
        document.querySelector(".content-display").style.visibility = "visible"
    }
    ...
    const instructions_pg10 = function () {
        ...
        content.innerHTML =
            ...
            `
        document.querySelector("#dyn-bttn-2").setAttribute("onClick", "javascript: event_boundary_task.instructions_pg9();")
    ...
    const show_choiceDisplay = function () {
        ...
        document.querySelector("#main-display").innerHTML =
            `<div>
                <div class="standard-display absolute-center">
                    <img src="images/stimuli/` + trials[block_counter][trial_counter].stim + `" style="width: 400px"></img>
                </div>
                <div>
                    <p> 
