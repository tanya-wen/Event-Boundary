% this script replaces MTurk and SONA IDs with a random string of characters and numbers
clear all; close all; clc;

addpath(genpath('/Users/tanyawen/Documents/GitHub/Event-Boundary'))
files = dir('/Users/tanyawen/Documents/GitHub/Event-Boundary/Experiment*/data/*.log');
