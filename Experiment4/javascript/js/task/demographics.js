        ...
        document.querySelector("#main-display").innerHTML =
            `<div class="content-display flex items-center flex-column" >
             <div style="width:80%; margin: 0"> 
                <p>Please take a few minutes to respond to the demographic questions below by filling in the appropriate response.</p>
             ...
             <div style="width:80%;">
                ...
                <p class="question-header">Do you have normal or corrected-to-normal vision?</p>
