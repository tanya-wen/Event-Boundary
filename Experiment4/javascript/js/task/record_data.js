...
function Data_row(obj) {
    ...
    this.answer = "NA";
    this.object = "NA";
    this.left_context = "NA";
    this.right_context = "NA";
    this.context_type = "NA";
    this.label_left = "NA";
    this.label_right = "NA";
    this.left_image = "NA";
    this.left_event = "NA";
    ...
    this.association_response_time = "NA";
    this.association_response = "NA";
    this.association_acc = "NA";

    this.order_response = "NA";
    this.order_response_time = "NA";
    this.order_acc = "NA";

    this.distance_response = "NA";
    this.distance_response_time = "NA";
...
function create_form() {
    let formHTML = [
            "<form id='sendtoPHP' method='post' action='https://dibs-web01.vm.duke.edu/AMTSubmit/DataHandler_TW.php'' style='display: none'>",
                ...
                "<input type='hidden' name='experiment-name' id = 'experiment-name' value='Temporal Perception' />",
            "</form>"
...
function submit_data() {
    ...
    for (let block = 0; block < 11; block++) {
        data = data.concat(event_boundary_task.trials[block])
        data = data.concat(event_boundary_task.asso_trials[block])
        data = data.concat(event_boundary_task.mem_trials[block])
    }
